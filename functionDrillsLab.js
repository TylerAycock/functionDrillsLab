...
//CODE HERE
function add (answerOne, answerTwo) {
  numOne = parseInt(answerOne)
  numTwo = parseInt(answerTwo)
...
// console.log(nameGreeting) figure out why this print undefined 
...
//CODE HERE
function FaveColorFinder (newColor) {
  if (newColor === `red`) {
    ...
    console.log(`you need to re-evaluate your favorite color choice`)
  }
}
...
//CODE HERE
let bestMovie = (movieTitle) => {return console.log(`${movieTitle} is the best movie ever!`)}

bestMovie(`Robin Hood`)
...
*/
let myEmailAddress = `new-email@gmail.com   `
function emailCheck(email) {
  ...
  if (email.includes(`@`)) {
    ...
    console.log(`must provide a valid email address ${myEmailAddress} is not valid`)
  }
  return console.log(email)
}

emailCheck(myEmailAddress)
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
function goldForCandy (coin) {
  let totalFrogs = 0
  while (coin >= 3 ) {
    coin -= 3
    totalFrogs += 1
  }
  return console.log(totalFrogs)
}
 goldForCandy(20)
